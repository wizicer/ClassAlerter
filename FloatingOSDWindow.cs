...
namespace ClassAlerter
{
    public class FloatingOSDWindow : FloatingWindow
    {
        ...
        {
            if (pt == base.Location && alpha == base.Alpha && textColor == this._brush.Color && text == this._text)
                return;
        ...
        protected override void PerformPaint(PaintEventArgs e)
        {
            ...
            TextShadow ts = new TextShadow();
            ts.Distance = 4;
            ts.Draw(g, this._text, this._textFont, base.Bound);
            g.FillPath(this._brush, this._gp);
            //g.DrawPath(new Pen(new SolidBrush(Color.White), 1), this._gp);
        }
        #endregion
